...
export const en = {
  ...
  "entry.detail.preparingUpgradeArtwork": "Preparing upgrade artwork…",
  "entry.progressLabel": "Editor preparation progress",
  "entry.progressCount": "{completed} of {total} editor tasks completed",
  "entry.artworkProgressCount": "{completed} of {total} upgrade assets prepared",
  "entry.artworkProgressAsset": "{completed} of {total} upgrade assets prepared · {asset}",
  "entry.localOnlyHint": "Preparing local editor data.",
  "entry.slowHint": "Still working — some local game data can take longer to prepare.",
  "entry.slowArtworkHint": "Still working — preparing upgrade artwork ({completed} of {total}).",
