...
export const id: Record<keyof typeof en, string> = {
  ...
  "upgrades.error": "Nilai upgrade harus antara 0 dan 2.147.483.647.",
  ...
  "run.levelError": "Level harus antara 1 dan 2.147.483.648.",
  "run.valueError": "{label} harus antara -2.147.483.648 dan 2.147.483.647.",
  ...
  "entry.detail.preparingUpgradeArtwork": "Menyiapkan gambar upgrade…",
  "entry.progressLabel": "Progres persiapan editor",
  "entry.progressCount": "{completed} dari {total} tugas editor selesai",
  "entry.artworkProgressCount": "{completed} dari {total} aset upgrade disiapkan",
  "entry.artworkProgressAsset": "{completed} dari {total} aset upgrade disiapkan · {asset}",
  "entry.localOnlyHint": "Menyiapkan data editor lokal.",
  "entry.slowHint": "Masih bekerja — beberapa data game lokal memerlukan waktu lebih lama.",
  "entry.slowArtworkHint": "Masih bekerja — menyiapkan gambar upgrade ({completed} dari {total}).",
