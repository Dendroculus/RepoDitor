...
export const ko: Record<keyof typeof en, string> = {
  ...
  "upgrades.error": "업그레이드 값은 0에서 2,147,483,647 사이의 정수여야 합니다.",
  "run.loading": "런 상태 불러오는 중…",
  "run.unavailable": "런을 사용할 수 없음",
  "run.expedition": "현재 원정",
  "run.description":
    "아래의 읽기 쉬운 값을 메모리에서 조정합니다. 선택한 세이브에는 아직 쓰지 않습니다.",
  "run.levelError": "레벨은 1에서 2,147,483,648 사이의 정수여야 합니다.",
  "run.valueError": "{label}은(는) -2,147,483,648에서 2,147,483,647 사이의 정수여야 합니다.",
  ...
  "entry.detail.preparingUpgradeArtwork": "업그레이드 이미지 준비 중…",
  "entry.progressLabel": "에디터 준비 진행률",
  "entry.progressCount": "에디터 작업 {total}개 중 {completed}개 완료",
  "entry.artworkProgressCount": "업그레이드 에셋 {total}개 중 {completed}개 준비됨",
  "entry.artworkProgressAsset": "업그레이드 에셋 {total}개 중 {completed}개 준비됨 · {asset}",
  "entry.localOnlyHint": "로컬 에디터 데이터를 준비하고 있습니다.",
  "entry.slowHint": "계속 작업 중입니다 — 일부 로컬 게임 데이터는 준비에 시간이 걸릴 수 있습니다.",
  "entry.slowArtworkHint": "계속 작업 중입니다 — 업그레이드 이미지 준비 중({completed}/{total}).",
